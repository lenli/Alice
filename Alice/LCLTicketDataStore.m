...
@implementation LCLTicketDataStore
...
{
    static LCLTicketDataStore *_shared = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _shared = [[LCLTicketDataStore alloc] init];
    });
...
- (NSFetchedResultsController *)ticketFRController
{
    if (!_ticketFRController)
    {
        ...
        [_ticketFRController performFetch:nil];
    }
    
    return _ticketFRController;
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Alice" withExtension:@"momd"];
